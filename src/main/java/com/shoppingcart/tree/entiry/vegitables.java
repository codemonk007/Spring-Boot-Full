...
@Document (collection = "vegitables")
@EntityScan
public class vegitables {
	...
	public vegitables(String name, String catagory, Boolean addToWishList, Boolean cartAdded, Float price,
	...
	public String toString() {
		return "vegitables [_id=" + id + ", name=" + name + ", catagory=" + catagory + ", addToWishList="
				+ addToWishList + ", cartAdded=" + cartAdded + ", Price=" + Price + ", imageurl=" + imageurl
